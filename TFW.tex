...
%\approx 120\pi\Omega
Feldwellenwiderstand: $Z_F = \sqrt{\frac{\mu}{\epsilon}}$, $Z_{F_0} = \sqrt{\frac{\mu_0}{\epsilon_0}}  \approx 377\Omega$\\
...
\begin{sectionbox}
	...
	Welle in Medium 2: $\mathbf{E}_2(z) = \tau E_{1i}e^{-j\beta_1z}\mathbf{u}_x$\\
	Stehwellenverhältnis: SWR = $\frac{|E_1|_{\text{max}}}{|E_1|_{\text{min}}} = \frac{1 + |\rho |}{1-|\rho |}$\\
	Maxima: $z_{\text{max}} = -\frac{n \lambda_1}{2}, n= 0,1,2,\dots$\\
	Minima: $z_{\text{min}} = -\frac{(2n+1) \lambda_1}{4}, n= 0,1,2,\dots$\\
\end{sectionbox}
...
\begin{sectionbox}
	...
	\end{emphbox}
	\begin{itemize}
		\item $b = n k_0 w_0^2$, mit Brechzahl $n = \sqrt{\epsilon \mu}$ \comment{???}
