...
\begin{sectionbox}
	...
	\begin{emphbox}
		$v_{p}=\frac{\omega}{\beta}$ $\Rightarrow$ $\frac{v_p}{c} = \frac{1}{\sqrt{1 - \left(\frac{f_c}{f}\right)^2}}$\\
	\end{emphbox}
	...
	\begin{emphbox}
		$v_{g}= \left(\frac{d \beta}{d \omega}\right)^{-1}$ $\Rightarrow$ $\frac{v_G}{c} = \frac{k_z}{k} = \sqrt{1-\left(\frac{f_c}{f}\right)^2}$\\
	\end{emphbox}
...
\begin{sectionbox}
	\subsection{E (TM)-Moden in kartesischen Koordinaten}
	\begin{center}\includegraphics[width = 4cm]{./img/TM-kartesisch.png}\end{center}
\end{sectionbox}
 
\begin{sectionbox}
	\subsection{H (TE)-Moden in kartesischen Koordinaten}
	\begin{center}\includegraphics[width = 4cm]{./img/TE-kartesisch.png}\end{center}
\end{sectionbox}

\begin{sectionbox}
	\subsection{E (TM)-Moden in Zylinderkoordinaten}
	\begin{center}\includegraphics[width = 4cm]{./img/TE-zylinder.png}\end{center}
\end{sectionbox}

\begin{sectionbox}
	\subsection{H (TE)-Moden in Zylinderkoordinaten}
	\begin{center}\includegraphics[width = 4cm]{./img/TM-zylinder.png}\end{center}
\end{sectionbox}
...
\begin{sectionbox}
	...
	\end{itemize}
	$\Rightarrow$ $b = a / 2$ für maximalen Einwelligkeitsbereich und geringe Verluste
...
\includegraphics[width=\textwidth]{./img/antenne_eff_fläche.png}
\begin{emphbox}
